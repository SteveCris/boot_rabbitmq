...
public class RuleConstants {
	...
	/**易极付-黑名单**/
	public final static String YJF_BLACK_LIST = "1200001";
	
	/**同盾设备指纹**/
	public final static String TD_FACILITY_SIMSERIAL = "0900001";
	 ...
	 * 近180天申请次数
	 * **/
	public final static String TD_FINAL_SCORE = "0900005";
	 ...
	 * 上海资信 禁止项配置
	 */
	public final static String SHANG_HAI_CREDIT_ACCOUNT_ABNORMAL = "1400001"; //账户状态非正常 账户状态异常为“关注”、“次级”、“可疑”、“损失” 表示命中 拒绝
	public final static String SHANG_HAI_CREDIT_IS_OVERDUE = "1400002"; //当前逾期 账户状态未结清，实际还款金额减去本月应还金额小于0拒绝
	public final static String SHANG_HAI_CREDIT_OVERDUE_SINGLE_COUNT = "1400003"; //单笔贷款最高逾期期数, 最高逾期期数大于等于3拒绝
	public final static String SHANG_HAI_CREDIT_OVERDUE_SINGLE_TOTAL = "1400004"; //单笔贷款累计逾期期数,累计逾期期数大于等于5拒绝
	public final static String SHANG_HAI_CREDIT_3_MONTH_HAVE_2_M1 = "1400005"; //单笔贷款近3个月有2个M1及以上,24月内各月还款状况近3个月显示有2个“1”，及以上表示命中拒绝
	public final static String SHANG_HAI_CREDIT_6_MONTH_HAVE_1_M2 = "1400006"; //单笔贷款近6个月有M2及以上,24月内各月还款状况近6个月显示有“2”及以上表示命中拒绝
	public final static String SHANG_HAI_CREDIT_6_MONTH_3_M1 = "1400007"; //单笔贷款近6个月有3个M1,24月内各月还款状况近6个月显示有三个“1”及以上表示命中拒绝
	public final static String SHANG_HAI_CREDIT_12_MONTH_4_M1 = "1400008"; //单笔贷款近12个月有4个M1, 24月内各月还款状况近12个月显示有四个“1”及以上表示命中拒绝
	public final static String SHANG_HAI_CREDIT_OVERDUE_TOTAL = "1400009"; //累计逾期期数,所有贷款累计逾期期数的和大于等于6拒绝
	public final static String SHANG_HAI_CREDIT_TARDY = "1400010"; //长期拖欠, 特殊交易信息记录类型显示“长期拖欠”表示命中拒绝
	public final static String SHANG_HAI_CREDIT_INDIVIDUAL_GUARANTEE_INDEMNITY = "1400011"; // 个人担保代偿, 特殊交易信息记录类型显示“个人担保代偿”表示命中拒绝
	public final static String SHANG_HAI_CREDIT_SINGLE_MAX_OVERDE = "1400012";//最高逾期期数最大值, 所有贷款中最高逾期期数的最大值大于等于3拒绝
	...
	/** 08-存在拒绝名单中 **/
	public final static String PLATFORM_BLACK = "0800001";//存在拒绝名单中
	/** 09-欺诈分拒绝 **/
